...
class MemoryEfficientSoftDiceLoss(nn.Module):
    ...
    def forward(self, x, y, loss_mask=None):
        # print("x-----------", x.shape) #(b, 2, x,y,z)
        # print("y-----------", y.shape) #(b, 1, x,y,z)
        ...
        # print("self.do_bg-----------", self.do_bg) #False
        if not self.do_bg:
            x = x[:, 1:]
        ...
        # print("self.ddp-----------", self.ddp) #False
        # print("self.batch_dice-----------", self.batch_dice) #True
        ...
        # print('--------MemoryEfficientSoftDiceLoss dc loss----', dc.shape)

        dc = dc.mean()
        # print('--------MemoryEfficientSoftDiceLoss dc loss----', dc)
