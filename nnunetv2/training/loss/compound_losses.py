...
class DC_and_CE_loss(nn.Module):
    ...
    def forward(self, net_output: torch.Tensor, target: torch.Tensor):
        ...
        :return:
        """
        # print("net_output-----------", net_output.shape) #(b, 2, x,y,z)
        # print("target-----------", target.shape) #(b, 1, x,y,z)
        ...
        if self.ignore_label is not None:
            ...
            target_dice = target
            mask = None
        # print("self.ignore_label-----------", self.ignore_label) #None
        ...
        # print('---------------weight_ce, weight_dice----', self.weight_ce, self.weight_dice)
        # print('DC_and_CE_loss-------', result)
